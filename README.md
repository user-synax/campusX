...
![Banner](https://capsule-render.vercel.app/api?type=waving&color=6366f1&height=300&section=header&text=CampusZen&fontSize=90&animation=fadeIn&fontAlignY=35&desc=For%20Indian%20College%20Students&descSize=24&descAlignY=55)
...
| | | |
|:---:|:---:|:---:|
| <img src="https://img.icons8.com/color/48/verified-account.png" width="40"/> **Verified Identity** | <img src="https://img.icons8.com/color/48/brain.png" width="40"/> **Smart Feed** | <img src="https://img.icons8.com/color/48/chat.png" width="40"/> **Real-time Chat** |
| College Email + OTP ✅ | AI-ranked posts 📊 | Pusher-powered 💬 |
| | | |
| <img src="https://img.icons8.com/color/48/administrative-tools.png" width="40"/> **Admin Panel** | <img src="https://img.icons8.com/color/48/iphone.png" width="40"/> **PWA Ready** | <img src="https://img.icons8.com/color/48/moon.png" width="40"/> **Dark Theme** |
...
|---|---|---|
| ⚡ Framework | Next.js 16 App Router | ![Next.js](https://img.shields.io/badge/Next.js-16-black) |
| ⚛️ UI Library | React 19 | ![React](https://img.shields.io/badge/React-19-61DAFB) |
| 🗄️ Database | MongoDB + Mongoose | ![MongoDB](https://img.shields.io/badge/MongoDB-47A248) |
| 🔐 Authentication | Better Auth + JWT | ![Auth](https://img.shields.io/badge/Auth-6366f1) |
| ⚡ Real-time | Pusher Channels | ![Pusher](https://img.shields.io/badge/Pusher-300D4F) |
| 📦 File Upload | UploadThing | ![UploadThing](https://img.shields.io/badge/UploadThing-6366f1) |
| 🎨 Styling | Tailwind CSS 4 | ![Tailwind](https://img.shields.io/badge/Tailwind-06B6D4) |
| ✨ Animations | Framer Motion + GSAP | ![Framer](https://img.shields.io/badge/Framer-6366f1) |
| 🎯 Components | shadcn/ui + Radix | ![shadcn](https://img.shields.io/badge/shadcn-6366f1) |
| ☁️ Deployment | Vercel | ![Vercel](https://img.shields.io/badge/Vercel-black) |
...
[![Built for every student who ever felt lost in college](https://img.shields.io/badge/⭐_Star_if_you_believe-every_campus_deserves_its_own_digital_home-6366f1?style=for-the-badge)](https://github.com/user-synax/campusX)
