    ...
    <div className="flex flex-col min-h-screen bg-[#0f0f0f] text-[#f0f0f0] overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 relative z-10">
        ...
        <div className="relative mb-8">
          <h1 className="text-9xl md:text-[12rem] font-black tracking-tighter select-none leading-none
                         bg-gradient-to-br from-[#6c3bff] via-[#3b82f6] to-[#8b5cf6] 
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 w-full max-w-sm justify-center">
          <Button asChild size="lg" className="rounded-full bg-primary hover:bg-primary/90 text-white font-bold h-14 px-8 shadow-xl shadow-primary/20">
            <Link href="/feed">
              Go to Feed
            </Link>
          </Button>
          <Button asChild variant="ghost" size="lg" className="rounded-full border border-white/10 hover:bg-white/5 h-14 px-8">
            <Link href="/">
              Go Home
            </Link>
          </Button>
