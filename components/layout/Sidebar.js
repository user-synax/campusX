        ...
        <aside className="fixed left-0 top-0 h-screen w-18 lg:w-70 border-r border-border bg-background z-50 hidden md:flex flex-col">
                            ...
                            <Link href={item.href}>
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        isActive
                                            ? "bg-accent text-accent-foreground font-bold hover:cursor-pointer"
            ...
            <div className="p-3 border-t border-border bg-background/50 backdrop-blur-md space-y-1">
                ...
                <div className="flex flex-col gap-1.5">
                    <Link
                        href={config.links.contactDeveloper || "#"}
                        target="_blank"
                    >
                        <Button
                            variant="ghost"
                            className="w-full justify-start gap-3 h-9 px-2 text-primary hover:text-primary hover:bg-primary/10 hover:cursor-pointer"
                        >
                            <Code className="w-4.5 h-4.5 shrink-0" />
