...
function buildOtpEmail(otp, purpose) {
  const heading =
    purpose === 'signup'
      ? 'Verify your email to join CampusX'
  ...
  const subtext =
    purpose === 'signup'
      ...
      : purpose === 'forgot_password'
      ? 'Enter this code to reset your CampusX account password.'
      : 'Enter this code to verify your college email address on CampusX.'
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;padding:40px 0;">
    <tr><td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background:#141414;border-radius:16px;border:1px solid #1e1e1e;overflow:hidden;">
        ...
        <!-- Header bar -->
        <tr>
          <td style="background:linear-gradient(135deg,#0d9f4f 0%,#16a34a 50%,#15803d 100%);padding:28px 32px;text-align:center;">
            <span style="font-size:26px;font-weight:800;color:#fff;letter-spacing:-0.5px;">Campus<span style="color:#bbf7d0;">X</span></span>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:36px 32px 12px;">
            <h1 style="margin:0 0 8px;font-size:20px;font-weight:700;color:#f5f5f5;">${heading}</h1>
            <p style="margin:0 0 28px;font-size:14px;color:#a3a3a3;line-height:1.6;">${subtext}</p>

            <!-- OTP box -->
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td align="center">
                <div style="background:#1a1a1a;border:1.5px dashed #22c55e;border-radius:12px;padding:20px 0;text-align:center;width:260px;margin:0 auto;">
                  <span style="font-size:36px;font-weight:800;letter-spacing:12px;color:#22c55e;font-family:'Courier New',monospace;">${otp}</span>
                </div>
              </td></tr>
            </table>
